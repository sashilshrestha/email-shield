...
export default function SecurityPoliciesPages() {
  ...
  const renderPoliciesTable = (policies) => {
    return (
      <div className="overflow-x-auto">
        <div className="flex justify-end mb-4">
          <div className="inline-flex items-center rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-1">
            <button
            ...
            <button
              onClick={() => setPolicyTypeFilter('file type')}
              className={`px-3 py-1 text-sm ${
                policyTypeFilter === 'file type'
                  ? 'bg-gray-100 dark:bg-gray-700 font-medium'
                  : ''
              }`}
            >
            ...
            <button
              onClick={() => setPolicyTypeFilter('domain')}
              className={`px-3 py-1 text-sm ${
                policyTypeFilter === 'domain'
                  ? 'bg-gray-100 dark:bg-gray-700 font-medium'
                  : ''
              }`}
            >
            ...
            <button
              onClick={() => setPolicyTypeFilter('content')}
              className={`px-3 py-1 text-sm ${
                policyTypeFilter === 'content'
                  ? 'bg-gray-100 dark:bg-gray-700 font-medium'
                  : ''
              }`}
            >
              ...
              >
                <div className="flex items-center">
                  <input
                    ...
                    onChange={() => handleSelectAll(policies)}
                  />
                </div>
              </th>
              <th
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-wrap gap-1">
                      {policy.patterns.map((item, index) => (
                        <span
                          key={index}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-2 py-1 rounded-full text-xs font-medium ${getActionClass(
                        policy.action
                      )}`}
                    >
                      {policy.action}
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {policy.enabled ? (
                      <span className="inline-flex items-center gap-1 rounded-full bg-green-100 px-2 py-1 text-xs font-semibold text-green-600 dark:bg-green-900/20 dark:text-green-400">
                        <Check className="h-3 w-3" />
                        Enabled
                      </span>
                    ) : (
                      <span className="inline-flex items-center gap-1 rounded-full bg-red-100 px-2 py-1 text-xs font-semibold text-red-600 dark:bg-red-900/20 dark:text-red-400">
    ...
    <div className="p-6 space-y-6">
      <div className="md:flex md:items-center md:justify-between">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <h1 className="text-2xl font-bold md:text-3xl">Security Policies</h1>
        </div>
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        Create a new security policy to protect your
      ...
      {activeTab === 'policies' && renderPoliciesTable(filteredPolicies)}
      {activeTab === 'user-reports' && renderUserReportsTable()}
    </div>
  );
}
