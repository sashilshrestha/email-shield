      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="p-6">
          ...
          {activeTab === 'integrations' && !showGmailIntegration && (
            <div className="space-y-6">
              <h2 className="text-lg font-medium">Email Integrations</h2>

              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-gray-100  rounded-full flex items-center justify-center mr-4">
                      <img src={GmailIcon} alt="" className="h-4" />
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 text-sm font-medium text-blue-600 dark:text-blue-400 border border-blue-600 dark:border-blue-400 rounded-md hover:bg-blue-50 dark:hover:bg-blue-900/20 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                  >
                    Connect
                  </button>
                </div>
          ...
          {activeTab === 'integrations' && showGmailIntegration && (
            <div className="space-y-6">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-medium">Gmail Integration</h2>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/30 rounded-lg p-6 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-6">
                  Connect your Gmail account to EmailShield to scan your emails
                  for malware, phishing attempts, and other threats.
                </p>
                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-md p-4 text-sm text-blue-800 dark:text-blue-300">
                    <p>
                      ...
                      emails for security threats and will not store your email
                      content.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <button className="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                      <a href="http://localhost:8000/auth">Connect to Gmail</a>
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>EmailShield will NOT send emails on your behalf</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>EmailShield will NOT store your email content</span>
                  </li>
                </ul>
              </div>
            </div>
